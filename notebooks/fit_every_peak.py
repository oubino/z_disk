...
for param in list(product(numberoflocalisationss, bin_sizes)):
    ...
    models = [
        ...
        zdisk_modelling.set_up_model_5_variable_peaks_no_bg_with_fit_settings(),
        zdisk_modelling.set_up_model_5_variable_peaks_bg_flat_with_fit_settings(),
        zdisk_modelling.set_up_model_5_variable_peaks_with_replocs_no_bg_with_fit_settings(),
